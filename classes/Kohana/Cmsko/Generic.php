...
/*
 * generic implementation of Cmsko driver. not contain any physical i/o operations
 * */

class Kohana_Cmsko_Generic extends Cmsko {

    protected $_map_links = array(); // url:nested:lang:host:user => id => _map[id] , или хранить одним списком добавив уникальный id
    ...
    {
        $path = APPPATH."content/cnodes/".$id.".txt";
